...
const VerifyPhone = () => {
  return (
    <div className="h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-800">
      <div className="max-w-lg  w-full mx-auto p-8">
        <h1 className="text-4xl font-bold my-2 max-w-md text-center">
          Verify your phone Number
        </h1>
        <p className="text-center">
          Verification code sent to 091234xxxx Please enter the code from your
          message box.
        </p>
        <div className="py-12 px-16 text-gray-700">
          ...
          <Link to="/home" className="btn" type="button">
            Verify
          </Link>
